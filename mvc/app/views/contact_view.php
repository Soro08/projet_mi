        ...
        <div class="container px-md-3 px-sm-0">
            ...
            <div class="row wow fadeIn">
                ...
                <div class="col-md-12 mb-4 white-text text-center wow fadeIn">
                    ...
                    <h3 class="display-5 font-weight-bold white-text mb-0 pt-md-5 pt-5">Contacts</h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-lg-0 mb-5 text-center" style="margin: auto;">
                <div class="avatar mx-auto">
                    <img src="public/assets/images/avatar/7.jpg" class="rounded-circle z-depth-1"
                         alt="Sample avatar">
                </div>
            ...
            <div class="col-lg-3 col-md-6 mb-lg-0 mb-5" style="margin: auto;">
                <div class="avatar mx-auto">
                    <img src="public/assets/images/avatar/1.jpg" class="rounded-circle z-depth-1"
                         alt="Sample avatar">
                </div>
